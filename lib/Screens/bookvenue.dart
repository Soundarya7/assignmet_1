...
import 'package:assignmet_1/Providers/bookingnotifier.dart';
      ...
      body: Column(
        children: [
          calendarState.when(
            ...
            loading: (){return CoustCalender(formattedBlockedDates);},
          ...
          Padding(
            ...
            child: Container(
              ...
              child: CoustEvalButton(
                onPressed: () {
                   ref.read(bookingProvider.notifier).Bookproperties(context,widget.property,_selectedDayString,ref);
                },
                buttonName: 'Book',
    ...
    return TableCalendar(
                ...
                calendarBuilders: CalendarBuilders(
                  defaultBuilder: (context, day, focusedDay) {
                    ...
                    print(
                        "sel  Dates ${_selectedDayString} && ${formattedDay} ");
