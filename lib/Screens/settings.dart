...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer(
        builder: (BuildContext context, WidgetRef ref, Widget? child) { return Column(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextButton(
                            onPressed: () {notification_settings();},
                            child: const Text(
